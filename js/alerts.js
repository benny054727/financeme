...
function alerts(){
  ...
  // m.loan (מתנועות אמיתיות, ראו genLoanPayments) ולא LOANS.allMonthlyTotal() החי —
  // אם loansAffectBalance כבוי (המשתמש עוקב אחרי ההלוואה בעצמו כהוראת קבע נפרדת),
  // m.loan=0 וההתראה לא סופרת את זה פעמיים על גבי ה-הוראת-קבע שכבר נספרת ב-m.out.
